...
Student.prototype.summary = function () {
  ...
  let assessmentsQuantity = function () {
     let res = 0;
    assessments.forEach(function (item) {
        res += 1;
    });
  ...
  let assessmentAverage = assessmentsSumm / assessmentsQuantity;
  ...
  let attendanceQuantity = function () {
    let res = 0;
    attendance.forEach(function (item) {
        res += 1;
    });
  ...
  let attendanceAvarage = attendanceSumm / attendanceQuantity;
